...
class SendRequest extends StatefulWidget {
  String? docId;
  bool? isvol;
   SendRequest({this.docId,this.isvol,Key? key}) : super(key: key);
                          ...
                          if (!isValid){ return;}else{
                            ...
                            if(widget.isvol!){
                              ...
                              FirebaseFirestore.instance
                                  .collection('events').doc(widget.docId).collection('volunteer')
                              ...
                              FirebaseFirestore.instance
                                  .collection('events').doc(widget.docId).collection('participants')
                                  .add({'name': textControllerone.text.trim(),
                                'phone': textControllerTwo.text.trim(),
                                'email': textControllerThree.text.trim(),
                                'docId':widget.docId,
